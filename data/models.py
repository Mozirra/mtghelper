...
class TeamType(models.Model):
    ...
    game_type_id = models.ForeignKey(GameType, models.CASCADE)
...
class GameDeck(models.Model):
    ...
    deck_id = models.ForeignKey('deck.Deck', models.CASCADE)
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL, models.CASCADE)
    round_eliminated = models.IntegerField()
    outcome_id = models.ForeignKey(Outcome, models.CASCADE)
    team_type_id = models.ForeignKey(TeamType, models.CASCADE)
